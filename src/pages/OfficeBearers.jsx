...
const OfficeBearers = () => {
    ...
    useEffect(() => {
        const sampleData = [
            ...
            { id: 95, name: 'VAISHNAVI ELANGO', position: 'EXECUTIVE MEMBER', department: 'IT' },
            { id: 96, name: 'SHANJEEVINI A S', position: 'EXECUTIVE MEMBER', department: 'AI-DS' },
            { id: 97, name: 'SEEMA M', position: 'EXECUTIVE MEMBER', department: 'AI-DS' },
